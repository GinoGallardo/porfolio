...
const Home = ({ onClick }) => {
  return (
    <section className="w-full mx-auto px-6 flex lg:px-8">
      <div className="flex flex-col max-w-7xl min-h-[45rem] p-2 gap-y-4 lg:flex-row items-center m-auto bg-transparent shadow-none rounded-lg lg:p-8 md:my-13 lg:gap-x-10 transition-opacity ease-out duration-[1200ms]">
        <Atropos
        ...
        <main className="text-white flex flex-col gap-y-4 lg:gap-y-6">
          ...
          <div className="flex items-center md:my-4 justify-between px-3 md:px-16 lg:mt-20">
            <Button className=" md:w-[12rem] md:text-2xl" onClick={onClick}>
              Descargar CV
            </Button>
            <SocialLinks />
          </div>
