...
const ProjectCardPreview = ({ item, onClick }) => {
  return (
    <div className='w-full sm:w-[90%] md:w-[48%] flex flex-col rounded-xl stack-glow transition duration-500 easy-in overflow-hidden relative h-[250px] hover:scale-102'>
