...
const Stack = () => {
  return (
    <section className="stack-glow bg-black opacity-90 max-w-7xl mb-20 mx-4 flex flex-col items-center justify-center rounded-2xl lg:py-20 lg:mt-30 lg:mx-auto">
